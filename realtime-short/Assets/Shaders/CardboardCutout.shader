        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				float4 Frag(PackedVaryingsMeshToPS packedInput ) : SV_Target
				{
					...
					surfaceDescription.Color =  tex2D( _MainTex, ase_worldViewDir.xy ).rgb;
					surfaceDescription.Alpha = 1;
					surfaceDescription.AlphaClipThreshold =  0;
...
ASEEND*/
//CHKSM=FB1EAAFD18718C00005CE5B3B2A2C7965C4EB473