    ...
    {        
        ...
        Pass
        {
						...
						)
			{
				...
				float2 uv235 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float mulTime238 = _Time.y * _TimeScale;
				float cos234 = cos( mulTime238 );
				float sin234 = sin( mulTime238 );
				float2 rotator234 = mul( uv235 - float2( 0.5,0.5 ) , float2x2( cos234 , -sin234 , sin234 , cos234 )) + float2( 0.5,0.5 );
                ...
                surfaceDescription.Smoothness = _Float0;
        ...
        Pass
        {
            ...
            HLSLPROGRAM
				...
				{				
					...
					BuiltinData builtinData;
					GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
					float2 uv235 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float mulTime238 = _Time.y * _TimeScale;
					float cos234 = cos( mulTime238 );
					float sin234 = sin( mulTime238 );
					float2 rotator234 = mul( uv235 - float2( 0.5,0.5 ) , float2x2( cos234 , -sin234 , sin234 , cos234 )) + float2( 0.5,0.5 );
...
/*ASEBEGIN
Version=16205
412.8;73.6;480;487;1341.318;697.1529;2.167519;False;False
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;235;-1166.875,-136.8005;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;238;-1114.875,208.1995;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RotatorNode;234;-863.8745,-46.80051;Float;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;226;-60.53448,-70.9281;Float;False;Property;_Float0;Float 0;6;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;217;-653.4761,-41.9763;Float;True;Property;_Normal;Normal;1;0;Create;True;0;0;False;0;None;302951faffe230848aa0d3df7bb70faa;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;208;7;226;0
WireConnection;208;9;204;4
WireConnection;208;16;225;0
WireConnection;208;17;223;0
WireConnection;208;18;224;0
WireConnection;208;19;222;0
WireConnection;208;24;233;4
WireConnection;208;25;231;0
ASEEND*/
//CHKSM=1C689D3B0A7E1E36DE73F53D830EEE93DC3B37AD